...
where
    "rlocked Cskip            = mset []"
  | "rlocked (Cassign x E)    = mset []"
  | "rlocked (Cread x E)      = mset []"
  | "rlocked (Cwrite E E')    = mset []"
  | "rlocked (Calloc x E)     = mset []"
  | "rlocked (Cdispose E)     = mset []"
  | "rlocked (Cseq C1 C2)     = (rlocked C1)"
  | "rlocked (Cpar C1 C2)     = (rlocked C1 + rlocked C2)"
  | "rlocked (Cif B C1 C2)    = mset []"
